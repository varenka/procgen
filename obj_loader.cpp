...
void IndexedModel::CalcNormals()
{
    ...
    {
        std::cout << "i=" << i << " indices.size()=" << indices.size() << " accessing indices[" << i + 2 << "]" << std::endl;
        std::cout << "positions.size()=" << positions.size() << " accessing positions[" << i + 2 << "]" << std::endl;
        std::cout << "normals.size()=" << normals.size() << " accessing normals[" << i + 2 << "]" << std::endl;
        int i0 = indices[i];
        int i1 = indices[i + 1];
        int i2 = indices[i + 2];
